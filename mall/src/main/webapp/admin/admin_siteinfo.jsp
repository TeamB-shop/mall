			...
			<section>
				...
				<div class="subpage_view">
					<ul class="info_form2">
						...
						<li>사업자등록번호</li>
						<li><input type="text" class="in_form0" name="cpno"
					...
					<ul class="info_form2">
						...
						<li>대표전화번호</li>
						<li><input type="text" class="in_form0" name="ceotel"
							value="<%=spdata.getCeotel() != null ? spdata.getCeotel() : ""%>"></li>
					</ul>
					<ul class="info_form2">
						<li>통신판매업 신고번호</li>
						<li><input type="text" class="in_form0" name="ecommno"
							value="<%=spdata.getEcommno() != null ? spdata.getEcommno() : ""%>"></li>
						<li>부가통신 사업자번호</li>
						<li><input type="text" class="in_form0" name="telcommno"
							value="<%=spdata.getTelcommno() != null ? spdata.getTelcommno() : ""%>"></li>
					</ul>
					<ul class="info_form2">
						<li>사업장 우편번호</li>
						<li><input type="text" class="in_form0" name="bzipcode"
					...
					<ul class="info_form2"
						style="border-bottom: 1px solid rgb(81, 61, 61);">
						<li>정보관리책임자명</li>
						<li><input type="text" class="in_form0" name="secname"
							value="<%=spdata.getSecname() != null ? spdata.getSecname() : ""%>"></li>
						<li>정보책임자 E-mail</li>
						<li><input type="text" class="in_form1" name="secmail"
				...
				<div class="subpage_view">
					<ul class="info_form2">
						...
						<li>은행계좌번호</li>
						<li><input type="text" class="in_form1" name="bankaccno"
...
<script src="./admin_siteinfo.js?v=3"></script>
</html>